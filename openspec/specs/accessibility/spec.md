...
> **Source**: Archived from change `responsive-a11y-font` (2026-06-04)
> **Capabilities**: `font-scaling`, `skip-to-content`, `reduced-motion`
...
| SC-02 | Link MUST be hidden until focused, then visible top-left with ≥3:1 contrast | MUST |
